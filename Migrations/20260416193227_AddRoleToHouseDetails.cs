...
{
    /// <inheritdoc />
    public partial class AddRoleToHouseDetails : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Houses", x => x.Eircode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseDetailsId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
